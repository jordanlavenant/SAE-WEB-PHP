...
require 'Classes/Groupes/DisplayGroupe.php';

use AsideHome\Aside;
use Groupe\DisplayGroupe;
...
class Groupe {
    ...
    function buildGroupe(): void {
        ...
        <main>
            <div class='header'>
                <a href='index.php?action=groupes'>
            ...
            $displayGroupe = new DisplayGroupe($this->artist);
            $displayGroupe->render();
        echo "
        </main>";
    }
}
